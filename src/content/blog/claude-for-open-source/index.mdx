...
I grew up on Windows. No opinions about editors, no `.config` folder I cared about. Then I installed WSL to poke at Linux, fell down the Ubuntu rabbit hole — Ghostty, then tmux, then vim — and stopped reaching for the mouse. Eventually I bought a Mac for the real Unix underneath, not a subsystem bolted onto an OS that fights you at every turn.
