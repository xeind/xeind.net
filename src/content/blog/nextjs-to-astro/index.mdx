...
<References>
  <Ref n={1} href="https://nextjs.org/docs/app/building-your-application/rendering">
    Next.js Rendering documentation — App Router hydration and server/client component model
  </Ref>
  <Ref n={2} href="https://www.radix-ui.com/primitives/docs/components/dropdown-menu">
    Radix UI Dropdown Menu — accessible but ships significant JS for simple menus
  </Ref>
  <Ref n={3} href="https://www.patterns.dev/react/react-selective-hydration">
    Selective Hydration in React 18 — patterns.dev
  </Ref>
  <Ref n={4} href="https://docs.astro.build/en/concepts/islands/">
    Astro Islands architecture — zero JS by default, opt-in interactivity
  </Ref>
  <Ref
    n={5}
    href="https://docs.astro.build/en/reference/configuration-reference/#buildinlinestylesheets"
  >
    Astro build.inlineStylesheets configuration reference
  </Ref>
  <Ref n={6} href="https://developers.cloudflare.com/workers/static-assets/">
