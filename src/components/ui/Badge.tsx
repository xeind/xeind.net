...
export default function Badge({ children, variant = "default", className = "" }: BadgeProps) {
  ...
  return (
    <span
      className={`bg-card bg-accent/8 relative inline-flex min-h-6 items-center justify-center gap-2 border border-dashed px-2 py-1 font-mono text-[0.6875rem] leading-tight transition-[background-color,border-color,color,opacity] ${variantStyles[variant]} ${className} `}
      style={{
