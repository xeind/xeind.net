...
export function DashedBorders() {
  return (
    <>
      <div
        className="border-accent/30 group-keyboard:border-solid absolute top-0 right-0 left-0 z-10 border-t border-dashed transition-colors group-hover:border-solid"
        style={t}
      />
      <div
        className="border-accent/30 group-keyboard:border-solid absolute top-0 right-0 bottom-0 z-10 border-r border-dashed transition-colors group-hover:border-solid"
        style={t}
      />
      <div
        className="border-accent/30 group-keyboard:border-solid absolute right-0 bottom-0 left-0 z-10 border-b border-dashed transition-colors group-hover:border-solid"
        style={t}
      />
      <div
        className="border-accent/30 group-keyboard:border-solid absolute top-0 bottom-0 left-0 z-10 border-l border-dashed transition-colors group-hover:border-solid"
        style={t}
      />
    </>
  );
  ...
  return (
    <>
      ...
      <div className="absolute top-0 left-0 z-10">
        <div
          className="bg-accent group-hover:bg-tertiary group-keyboard:bg-tertiary h-px w-2 transition-colors"
          style={t}
        />
        <div
          className="bg-accent group-hover:bg-tertiary group-keyboard:bg-tertiary h-2 w-px transition-colors"
          style={t}
        />
      </div>
      {/* Top-Right */}
      <div className="absolute top-0 right-0 z-10">
        <div
          className="bg-accent group-hover:bg-tertiary group-keyboard:bg-tertiary ml-auto h-px w-2 transition-colors"
          style={t}
        />
        <div
          className="bg-accent group-hover:bg-tertiary group-keyboard:bg-tertiary ml-auto h-2 w-px transition-colors"
          style={t}
        />
      </div>
      {/* Bottom-Left */}
