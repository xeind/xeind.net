...
function XeinLogoComponent({ className = "", size = 48 }: XeinLogoProps) {
  return (
    <svg
      ...
      focusable="false"
    >
      {/* Left side "X" - Individual hover on this group */}
      <g className="opacity-90 transition-opacity duration-300 ease-out hover:opacity-100">
        <polygon
      ...
      {/* Right side "D" - Individual hover on this group */}
      <g className="opacity-90 transition-opacity duration-300 ease-out hover:opacity-100">
        {/* Top-right quadrant */}
        <polygon
          className="fill-accent"
