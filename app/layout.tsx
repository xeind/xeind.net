        ...
        <style
          dangerouslySetInnerHTML={{
            __html: `
              ...
              [data-theme=tokyo-night]{--color-background:hsl(235 18% 14%);--color-foreground:hsl(218 18% 84%);--color-card:hsl(235 16% 18%);--color-border:hsl(235 12% 28%);--color-muted:hsl(235 15% 16%);--color-accent:hsl(187 47% 55%);--color-accent-hover:hsl(187 47% 65%);--color-destructive:hsl(0 72% 65%);--color-success:hsl(158 64% 52%);--color-primary:hsl(187 47% 55%);--color-primary-hover:hsl(187 47% 65%);--color-secondary:hsl(267 51% 70%);--color-secondary-hover:hsl(267 51% 80%);--color-tertiary:hsl(261 85% 78%);--color-tertiary-hover:hsl(261 85% 88%);--color-info:hsl(215 58% 70%);--color-warning:hsl(32 86% 65%)}
              [data-theme=gruvbox]{--color-background:hsl(30 9% 16%);--color-foreground:hsl(68 25% 76%);--color-card:hsl(30 9% 21%);--color-border:hsl(30 7% 35%);--color-muted:hsl(30 9% 13%);--color-accent:hsl(43 94% 59%);--color-accent-hover:hsl(43 94% 69%);--color-destructive:hsl(4 89% 60%);--color-success:hsl(62 71% 45%);--color-primary:hsl(43 94% 59%);--color-primary-hover:hsl(43 94% 69%);--color-secondary:hsl(27 75% 57%);--color-secondary-hover:hsl(27 75% 67%);--color-tertiary:hsl(3 84% 60%);--color-tertiary-hover:hsl(3 84% 70%);--color-info:hsl(180 25% 55%);--color-warning:hsl(27 75% 57%)}
              [data-theme=kanagawa]{--color-background:hsl(240 17% 15%);--color-foreground:hsl(42 27% 80%);--color-card:hsl(240 17% 18%);--color-border:hsl(240 10% 30%);--color-muted:hsl(240 17% 12%);--color-accent:hsl(263 28% 60%);--color-accent-hover:hsl(263 28% 70%);--color-destructive:hsl(353 69% 65%);--color-success:hsl(86 36% 57%);--color-primary:hsl(263 28% 60%);--color-primary-hover:hsl(263 28% 70%);--color-secondary:hsl(38 66% 70%);--color-secondary-hover:hsl(38 66% 80%);--color-tertiary:hsl(86 36% 57%);--color-tertiary-hover:hsl(86 36% 67%);--color-info:hsl(194 32% 63%);--color-warning:hsl(27 68% 70%)}
